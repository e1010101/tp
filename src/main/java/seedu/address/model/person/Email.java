...
public class Email {
    ...
    public static final String MESSAGE_CONSTRAINTS = "Emails should be of the format local-part@domain "
                                                     ...
                                                     + "characters and these special characters, excluding "
                                                     ...
                                                     + "    - have each domain label start and "
                                                     + "end with alphanumeric characters\n"
                                                     + "    - have each domain label consist of "
                                                     + "alphanumeric characters, separated only by hyphens, if any.";
